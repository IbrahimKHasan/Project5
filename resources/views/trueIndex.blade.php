                                    ...
                                    <div class="posts-section">
                                        @foreach ($posts as $post)
                                            <div class="post-bar">
                                                ...
                                                <div class="epi-sec">
                                                    <ul class="descp">
                                                        <li><img src="images/icon8.png" alt=""><span>Front End
                                                                Developer</span></li>
                                                ...
                                                <div class="job-status-bar">
                                                    <ul class="like-com">
                                                        ...
                                                        <li><a href="#" class="com"><i
                                                                    class="fas fa-comment-alt"></i> Comments 15</a>
                                                        </li>
                                                    </ul>
...
<!-- Mirrored from gambolthemes.net/workwise-new/projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Dec 2021 15:25:05 GMT -->
